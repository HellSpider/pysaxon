...
int XdmItem::size(){
    std::cout<<"C++: In XdmItem::size()"<<std::endl;
    std::cout<<"C++: XdmItem* = "<<this<<std::endl;
    return 1;
}
...
const char * XdmItem::getStringValue(SaxonProcessor * proc1){
    std::cout<<"C++: In XdmItem::getStringValue()"<<std::endl;
    std::cout<<"C++: SaxonProcessor* = "<<proc1<<std::endl;
    if(proc1 != NULL) {
        proc = proc1;
    }
    if(proc != NULL) {
        std::cout<<"C++: SaxonProcessor* = "<<proc<<std::endl;
