...
SaxonProcessor::SaxonProcessor(bool l){
    ...
    versionStr = NULL;
    refCount++;
    std::cout<<"C++: In SaxonProcessor::SaxonProcessor(bool l)"<<std::endl;
    std::cout<<"C++: l = "<<l<<std::endl;
    std::cout<<"C++: refCount = "<<refCount<<std::endl;
    std::cout<<"C++: before environ = "<<environ<<std::endl;
    if(!environ){
        environ = new sxnc_environment;//(sxnc_environment *)malloc(sizeof(sxnc_environment));
        std::cout<<"C++: after environ = "<<environ<<std::endl;
        ...
        std::cout<<"C++: environ->myDllHandle = "<<environ->myDllHandle<<std::endl;
    ...
    std::cout<<"C++: SaxonProcessor* = "<<this<<std::endl;
...
SaxonProcessor::~SaxonProcessor(){
    std::cout<<"C++: In SaxonProcessor::~SaxonProcessor()"<<std::endl;
    std::cout<<"C++: SaxonProcessor* = "<<this<<std::endl;
    clearConfigurationProperties();
    std::cout<<"C++: refCount = "<<refCount<<std::endl;
    std::cout<<"C++: environ = "<<environ<<std::endl;
    if(refCount<= 1) {
        std::cout<<"C++: Calling release()"<<std::endl;
        release();
        std::cout<<"C++: Deleting environ"<<std::endl;
        delete environ;
   } else  {
    std::cout<<"C++: Reducing refCount by one"<<std::endl;
    refCount--;
    std::cout<<"C++: refCount = "<<refCount<<std::endl;
}
...
XPathProcessor * SaxonProcessor::newXPathProcessor(){
    std::cout<<"C++: In SaxonProcessor::newXPathProcessor()"<<std::endl;
    std::cout<<"C++: SaxonProcessor* = "<<this<<std::endl;
    std::cout<<"C++: environ = "<<environ<<std::endl;
    applyConfigurationProperties();
...
XdmNode * SaxonProcessor::parseXmlFromString(const char* source){
    ...
    std::cout<<"C++: In SaxonProcessor::parseXmlFromString()"<<std::endl;
    std::cout<<"C++: SaxonProcessor* = "<<this<<std::endl;
    std::cout<<"C++: environ = "<<environ<<std::endl;
...
const char * SaxonProcessor::getStringValue(XdmItem * item){
    std::cout<<"C++: In SaxonProcessor::getStringValue()"<<std::endl;
    std::cout<<"C++: SaxonProcessor* = "<<this<<std::endl;
    std::cout<<"C++: XdmItem* = "<<item<<std::endl;
    std::cout<<"C++: environ* = "<<environ<<std::endl;
    const char *result = stringValue(*environ, item->getUnderlyingValue(this));
    // const char *result = "You was here!";
#ifdef DEBUG
    if(result == NULL) {
